      ...
      <Container className={"mb-5"} style={{ marginTop: 32 }}>
        ...
        <Row className={"mt-5"}>
          <Col lg={3} md={4} sm={6} xs={12}>
            <img
              className={s.img}
              src={"/images/e-commerce/team/person1.jpg"}
            />
            ...
            >
              <img
                src={"/images/e-commerce/team/google.svg"}
                className={"mr-4"}
              />
              <img
                src={"/images/e-commerce/team/facebook.svg"}
                className={"mr-4"}
              />
              <img src={"/images/e-commerce/team/behance.svg"} />
            </div>
          </Col>
          <Col lg={3} md={4} sm={6} xs={12}>
            <img
              className={s.img}
              src={"/images/e-commerce/team/person2.jpg"}
            />
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            <img
              className={s.img}
              src={"/images/e-commerce/team/person3.jpg"}
            />
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            <img
              className={s.img}
              src={"/images/e-commerce/team/person4.jpg"}
            />
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            <img
              className={s.img}
              src={"/images/e-commerce/team/person5.jpg"}
            />
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            <img
              className={s.img}
              src={"/images/e-commerce/team/person6.jpg"}
            />
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            <img
              className={s.img}
              src={"/images/e-commerce/team/person7.jpg"}
            />
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            <img
              className={s.img}
              src={"/images/e-commerce/team/person8.jpg"}
            />
